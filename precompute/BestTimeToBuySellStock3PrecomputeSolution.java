 ...
 */
public class BestTimeToBuySellStock3PrecomputeSolution {
    ...
    public void testCase7() {
        int[] prices = new int[] {3,5,3,4,1,4,5,0,7,8,5,6,9,4,1};
        BestTimeToBuySellStock3PrecomputeSolution solution = new BestTimeToBuySellStock3PrecomputeSolution();
        int maxProfit = solution.maxProfit(prices);
        assertEquals(13, maxProfit);
    }
    ...
    public static void main(String[] args) {
        Result result = JUnitCore.runClasses(BestTimeToBuySellStock3PrecomputeSolution.class);
